...
import { getStaticData } from "../../api/institucionAPI";
import { useQuery } from "@tanstack/react-query";
import { TIPOS } from "../../types/types";
import PropTypes from "prop-types";

const Footer2 = ({ institucion = null }) => {
    ...
    if (institucion && !loading_static_data) {
        ...
        }/InstitucionUpea/Portada/${filter_portadas[0].portada_imagen}`;
                            ...
                            <div className="row">
                                <div className="sx-footer-bot-left">
                                    <span className="copyrights-text">
                                        © Universidad Pública de El Alto 2023 -
                                    ...
                                    <span>
                                        web developer{" "}
                                        <a
                                            href="https://www.linkedin.com/in/cristhian-villca-mamani-06933b251/"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            style={{ color: "#00B4DB" }}
                                        >

...
const Autoridades2 = ({ separatoralignment, institucion = null }) => {
    ...
    if (institucion && !loading_static_data) {
        ...
        return (
            <>
                <div
                    className="section-full mobile-page-padding bg-repeat p-t80 p-b80"
                    ...
                    <div className="section-content">
                        <div className="container">
                            ...
                            <div className="section-head">
                                <div
                                    className={`${separatoralignment} sx-separator-outer`}
                                >
                                    <div

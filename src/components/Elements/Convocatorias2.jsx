...
const Convocatorias2 = ({ tipo, institucion = null }) => {
    ...
    if (
        ...
        /* DATOS ESTATICOS */
        const { txt_content_convocatorias } = staticData;
                                    ...
                                    {lastConvocatoria && (
                                        <NavLink
                                            to={`/detalle/${
                                                ...
                                                lastConvocatoria.idconvocatorias
                                            )}`}
                                        >
                                            <div className="number-block-one animate-in-to-top">
                                                <img
                                                    src={`${
                                                        ...
                                                        lastConvocatoria.con_foto_portada
                                                    }`}
                                                    alt=""
                                                />
                                    ...
                                    {lastComunicado && (
                                        <NavLink
                                            to={`/detalle/${
                                                ...
                                                lastComunicado.idconvocatorias
                                            )}`}
                                        >
                                            <div className="number-block-one animate-in-to-top">
                                                <img
                                                    src={`${
                                                        ...
                                                        lastComunicado.con_foto_portada
                                                    }`}
                                                    alt=""
                                                />
                                                <div className="figcaption bg-white text-center p-a20">
                                            ...
                                            <div className="number-block-one animate-in-to-top">
                                                <img
                                                    src={`${
                                                        ...
                                                        lastAviso.con_foto_portada
                                                    }`}
                                                    alt=""
                                                />
                                                <div className="figcaption bg-white text-center p-a20">
                                                    <h4 className="m-a0">
                                                        {lastAviso.con_titulo}
                                                    </h4>
                                                </div>
                                                <div className="figcaption-number text-center sx-text-primary animate-in-to-top-content">
                                                    <span>03</span>
    ...
    if (
        ...
        const { txt_content_cursos } = staticData;
                                    ...
                                    <div className="col-lg-4 col-md-6 col-sm-6 m-b30">
                                        <NavLink
                                            to={`/detalle/${
                                                ...
                                                lastCurso.iddetalle_cursos_academicos
                                            )}`}
                                        >
                                            <div className="number-block-one animate-in-to-top">
                                                <img
                                                    src={`${
                                                        ...
                                                        lastCurso.det_img_portada
                                                    }`}
                                                    alt=""
                                                />
                                                <div className="figcaption bg-white text-center p-a20">
                                                    <h4 className="m-a0">
                                                        {lastCurso.det_titulo}
                                                    </h4>
                                                </div>
                                                <div className="figcaption-number text-center sx-text-primary animate-in-to-top-content">
                                                    <span>04</span>
                                    ...
                                    <div className="col-lg-4 col-md-6 col-sm-6 m-b30">
                                        <NavLink
                                            to={`/detalle/${
                                                ...
                                                lastSeminario.iddetalle_cursos_academicos
                                            )}`}
                                        >
                                            <div className="number-block-one animate-in-to-top">
                                                <img
...
Convocatorias2.propTypes = {
    ...
    institucion: PropTypes.object, // Ajusta el tipo según lo que esperas
};
